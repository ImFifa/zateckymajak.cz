...
use App\Grid\IArticleGridFactory;
...
class ArticlePresenter extends BasePresenter
{
	...
	/** @var IArticleGridFactory */
	private $articleGridFactory;

	public function __construct(ArticleModel $articleModel, CategoryModel $categoryModel, GalleryModel $galleryModel, FolderModel $folderModel, IArticleGridFactory $articleGridFactory)
	{
		parent::__construct();
